 ...
 */
// Calling the above mentioned function
...
// alternative method for this todo question
...
console.log(calculateTip(0.20, 50.5));
console.log(calculateTip(0.20, 10.3));
 ...
 */
 ...
 let tipPercentage = parseFloat(prompt("what % would you like to tip"));
 //+ also changed float number into real numbers
 let totalBill = +(prompt("what is your total bill ?"));


 alert("The Suggested tip amount : $" + calculateTip(tipPercentage , totalBill));
